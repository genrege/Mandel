...
namespace MandelbrotViewer
{
    class MandelbrotDLLInterface
    {
        ...
        [DllImport(@"MandelbrotRenderer.dll")] public static extern void calculateJulia2(double re, double im, bool gpu, int maxIterations, int width, int height, double xMin, double xMax, double yMin, double yMax, [MarshalAs(UnmanagedType.SafeArray)] ref int[] result);
        ...
        [DllImport(@"MandelbrotRenderer.dll")] public static extern void paletteTransform2([MarshalAs(UnmanagedType.SafeArray)] int[] input, [MarshalAs(UnmanagedType.SafeArray)] int[] palette, [MarshalAs(UnmanagedType.SafeArray)] ref int[] result);
