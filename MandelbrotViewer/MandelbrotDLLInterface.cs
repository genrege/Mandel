...
namespace MandelbrotViewer
{
    class MandelbrotDLLInterface
    {
        ...
        [DllImport(@"MandelbrotRenderer.dll")] public static extern void renderMandelbrot(int gpuIndex, IntPtr hdc, bool gpu, bool cuda, int maxIterations, int screenWidth, int screenHeight, double xMin, double xMax, double yMin, double yMax);
        [DllImport(@"MandelbrotRenderer.dll")] public static extern void renderJulia(int gpuIndex, IntPtr hdc, bool gpu, bool cuda, int maxIterations, double re, double im, int screenWidth, int screenHeight, double xMin, double xMax, double yMin, double yMax);
