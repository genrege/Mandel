...
extern "C" DLL_API void calculateBuddha(bool antiBuddha, int maxIterations, int screenWidth, int screenHeight, double xMin, double xMax, double yMin, double yMax, SAFEARRAY * *ppsa);
extern "C" DLL_API void paletteTransform(SAFEARRAY * input, SAFEARRAY * palette, SAFEARRAY * *ppsa);
extern "C" DLL_API void paletteTransform2(SAFEARRAY * input, SAFEARRAY * palette, SAFEARRAY * *ppsa);
